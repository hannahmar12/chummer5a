namespace Chummer
{
    partial class frmSelectCyberware
    {
        ...
        private void InitializeComponent()
        {
			...
			this.gpbEssFilter = new System.Windows.Forms.GroupBox();
			this.tlpKarmaFilter = new Chummer.BufferedTableLayoutPanel(this.components);
			this.lblMinimumESS = new System.Windows.Forms.Label();
			this.lblESS = new System.Windows.Forms.Label();
			this.lblMaxESS = new System.Windows.Forms.Label();
			this.nudMinimumESS = new Chummer.NumericUpDownEx();
			this.nudExactESS = new Chummer.NumericUpDownEx();
			this.nudMaximumESS = new Chummer.NumericUpDownEx();
			...
			this.gpbEssFilter.SuspendLayout();
			this.tlpKarmaFilter.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.nudMinimumESS)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.nudExactESS)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.nudMaximumESS)).BeginInit();
			...
			this.tlpMain.Controls.Add(this.gpbEssFilter, 1, 3);
			...
			this.chkHideBannedGrades.Location = new System.Drawing.Point(309, 340);
			...
			this.tlpRight.Size = new System.Drawing.Size(460, 310);
			this.tlpRight.TabIndex = 79;
			// 
			// gpbEssFilter
			// 
			this.gpbEssFilter.AutoSize = true;
			this.gpbEssFilter.AutoSizeMode = System.Windows.Forms.AutoSizeMode.GrowAndShrink;
			this.gpbEssFilter.Controls.Add(this.tlpKarmaFilter);
			this.gpbEssFilter.Location = new System.Drawing.Point(309, 364);
			this.gpbEssFilter.Name = "gpbEssFilter";
			this.gpbEssFilter.Size = new System.Drawing.Size(113, 97);
			this.gpbEssFilter.TabIndex = 79;
			this.gpbEssFilter.TabStop = false;
			this.gpbEssFilter.Tag = "Label_FilterByEssence";
			this.gpbEssFilter.Text = "Filter by Essence:";
			// 
			// tlpKarmaFilter
			// 
			...
			this.tlpKarmaFilter.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
			this.tlpKarmaFilter.Controls.Add(this.lblMinimumESS, 0, 0);
			this.tlpKarmaFilter.Controls.Add(this.lblESS, 0, 1);
			this.tlpKarmaFilter.Controls.Add(this.lblMaxESS, 0, 2);
			this.tlpKarmaFilter.Controls.Add(this.nudMinimumESS, 1, 0);
			this.tlpKarmaFilter.Controls.Add(this.nudExactESS, 1, 1);
			this.tlpKarmaFilter.Controls.Add(this.nudMaximumESS, 1, 2);
			...
			// lblMinimumESS
			// 
			this.lblMinimumESS.Anchor = System.Windows.Forms.AnchorStyles.Right;
			this.lblMinimumESS.AutoSize = true;
			this.lblMinimumESS.Location = new System.Drawing.Point(6, 6);
			this.lblMinimumESS.Margin = new System.Windows.Forms.Padding(3, 6, 3, 6);
			this.lblMinimumESS.Name = "lblMinimumESS";
			this.lblMinimumESS.Size = new System.Drawing.Size(51, 13);
			this.lblMinimumESS.TabIndex = 19;
			this.lblMinimumESS.Tag = "Label_CreateImprovementMinimum";
			this.lblMinimumESS.Text = "Minimum:";
			// 
			// lblESS
			// 
			this.lblESS.Anchor = System.Windows.Forms.AnchorStyles.Right;
			this.lblESS.AutoSize = true;
			this.lblESS.Location = new System.Drawing.Point(13, 32);
			this.lblESS.Margin = new System.Windows.Forms.Padding(3, 6, 3, 6);
			this.lblESS.Name = "lblESS";
			this.lblESS.Size = new System.Drawing.Size(44, 13);
			this.lblESS.TabIndex = 20;
			this.lblESS.Tag = "Label_CreateImprovementExactly";
			this.lblESS.Text = "Exactly:";
			// 
			// lblMaxESS
			// 
			this.lblMaxESS.Anchor = System.Windows.Forms.AnchorStyles.Right;
			this.lblMaxESS.AutoSize = true;
			this.lblMaxESS.Location = new System.Drawing.Point(3, 58);
			this.lblMaxESS.Margin = new System.Windows.Forms.Padding(3, 6, 3, 6);
			this.lblMaxESS.Name = "lblMaxESS";
			this.lblMaxESS.Size = new System.Drawing.Size(54, 13);
			this.lblMaxESS.TabIndex = 21;
			this.lblMaxESS.Tag = "Label_CreateImprovementMaximum";
			this.lblMaxESS.Text = "Maximum:";
			// 
			// nudMinimumESS
			// 
			this.nudMinimumESS.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Left | System.Windows.Forms.AnchorStyles.Right)));
			this.nudMinimumESS.AutoSize = true;
			this.nudMinimumESS.Location = new System.Drawing.Point(63, 3);
			this.nudMinimumESS.Maximum = new decimal(new int[] {
            100,
            0,
            0,
            0});
			this.nudMinimumESS.Minimum = new decimal(new int[] {
            100,
            0,
            0,
            -2147483648});
			this.nudMinimumESS.Name = "nudMinimumESS";
			this.nudMinimumESS.Size = new System.Drawing.Size(41, 20);
			this.nudMinimumESS.TabIndex = 16;
			this.nudMinimumESS.ValueChanged += new System.EventHandler(this.EssenceFilter);
			// 
			// nudExactESS
			// 
			this.nudExactESS.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Left | System.Windows.Forms.AnchorStyles.Right)));
			this.nudExactESS.AutoSize = true;
			this.nudExactESS.Location = new System.Drawing.Point(63, 29);
			this.nudExactESS.Maximum = new decimal(new int[] {
            100,
            0,
            0,
            0});
			this.nudExactESS.Minimum = new decimal(new int[] {
            100,
            0,
            0,
            -2147483648});
			this.nudExactESS.Name = "nudExactESS";
			this.nudExactESS.Size = new System.Drawing.Size(41, 20);
			this.nudExactESS.TabIndex = 17;
			this.nudExactESS.ValueChanged += new System.EventHandler(this.EssenceFilter);
			// 
			// nudMaximumESS
			// 
			this.nudMaximumESS.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Left | System.Windows.Forms.AnchorStyles.Right)));
			this.nudMaximumESS.AutoSize = true;
			this.nudMaximumESS.Location = new System.Drawing.Point(63, 55);
			this.nudMaximumESS.Maximum = new decimal(new int[] {
            100,
            0,
            0,
            0});
			this.nudMaximumESS.Minimum = new decimal(new int[] {
            100,
            0,
            0,
            -2147483648});
			this.nudMaximumESS.Name = "nudMaximumESS";
			this.nudMaximumESS.Size = new System.Drawing.Size(41, 20);
			this.nudMaximumESS.TabIndex = 18;
			this.nudMaximumESS.ValueChanged += new System.EventHandler(this.EssenceFilter);
			// 
			// lblEssence
			// 
			...
			this.gpbEssFilter.ResumeLayout(false);
			this.gpbEssFilter.PerformLayout();
			this.tlpKarmaFilter.ResumeLayout(false);
			this.tlpKarmaFilter.PerformLayout();
			((System.ComponentModel.ISupportInitialize)(this.nudMinimumESS)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.nudExactESS)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.nudMaximumESS)).EndInit();
        ...
        private System.Windows.Forms.GroupBox gpbEssFilter;
        private BufferedTableLayoutPanel tlpKarmaFilter;
        private System.Windows.Forms.Label lblMinimumESS;
        private System.Windows.Forms.Label lblESS;
        private System.Windows.Forms.Label lblMaxESS;
        private NumericUpDownEx nudMinimumESS;
        private NumericUpDownEx nudExactESS;
        private NumericUpDownEx nudMaximumESS;
    }
}
